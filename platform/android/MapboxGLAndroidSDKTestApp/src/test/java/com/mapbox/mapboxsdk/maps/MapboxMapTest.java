...
//
//    @InjectMocks
//    MyLocationViewSettings myLocationViewSettings = mock(MyLocationViewSettings.class);
//
//    @InjectMocks
//    Projection projection = mock(Projection.class);
//
//    @InjectMocks
//    MapboxMap.OnRegisterTouchListener onRegisterTouchListener = mock(MapboxMap.OnRegisterTouchListener.class);
//
//    @InjectMocks
//    AnnotationManager annotationManager = mock(AnnotationManager.class);
//
//    @Mock
...
//        //System.setProperty("java.library.path", "/home/tvn/Mapbox/mapbox-gl-native/platform/android/MapboxGLAndroidSDK/src/main/jniLibs/x86_64/libmapbox-gl.so");
//        MockitoAnnotations.initMocks(this);
//        mMapboxMap = new MapboxMap(new NativeMapView(mapView), transform, uiSettings, trackingSettings, myLocationViewSettings, projection, onRegisterTouchListener, annotationManager);
//    }
//
//    @Test
...
//        when(trackingSettings.isPermissionsAccepted()).thenReturn(true);
